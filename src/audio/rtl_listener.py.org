...
# Per-mode rtl_fm arguments. "wbfm" is an rtl_fm alias that sets its own
# sample/resample rates (170k/32k) and de-emphasis; explicit -s would
# override it, so wfm passes none.
_MODES = {
    "nfm": {"rtl_mode": "fm", "sample_args": ["-s", "16000"], "audio_rate": 16000},
    "am":  {"rtl_mode": "am", "sample_args": ["-s", "16000"], "audio_rate": 16000},
    "usb": {"rtl_mode": "usb", "sample_args": ["-s", "16000"], "audio_rate": 16000},
    "lsb": {"rtl_mode": "lsb", "sample_args": ["-s", "16000"], "audio_rate": 16000},
    "wfm": {"rtl_mode": "wbfm", "sample_args": [], "audio_rate": 32000},
}
...
class RtlListener:
    ...
    async def _start_locked(self) -> None:
        ...
        rtl_cmd = ["rtl_fm", "-M", spec["rtl_mode"], *spec["sample_args"],
        ...
        cmd = " ".join(rtl_cmd) + " | " + " ".join(ffmpeg_cmd)
