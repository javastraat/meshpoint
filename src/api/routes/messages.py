...
async def send_message(
    ...
    # Reticulum has its own send path (POST /api/reticulum/send, owned by
    # the reticulum plugin) -- the Messages page posts there directly for
    # protocol='reticulum' conversations, so nothing reaches here.
