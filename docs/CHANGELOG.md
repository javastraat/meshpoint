...
- **Hardware page: Meshtastic settings unified in one card.** The "Radio Configuration" card is now "Meshtastic Configuration" and includes the Meshtastic channel table (name, masked PSK, hash, state); the separate Channels card is gone.
