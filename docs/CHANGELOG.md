...
- **Topbar chips agree on "Reconnecting…".** When the dashboard connection drops, the Meshtastic USB chip now says "Reconnecting…" like the MeshCore chip, instead of blanking to dashes.
