...
Only one of Radio / P2000 / Pagers / POCSAG / DAB+ may hold the RTL-SDR dongle at a time (the RTL433, ADS-B and ACARS plugins join that set when installed -- see their own `plugins/apps/*/README.md`).
