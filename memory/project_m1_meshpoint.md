...
locally at /Users/einstein/Software/meshtastic (user-supplied) — already used once
for [[T13]]'s channel-hash frequency formula; good resource for any future
question needing firmware-level (not just meshtastic-python-level) ground truth.
