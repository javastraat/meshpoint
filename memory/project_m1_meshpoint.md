...
| — | Open | M | **Server-side downsampling for the Repeater Trends chart** — fixed limit (`hours=100000&limit=50000`) will eventually start truncating again as rows grow |
