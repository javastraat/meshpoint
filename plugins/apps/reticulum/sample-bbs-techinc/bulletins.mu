#!c=1
# TechInc Mesh BBS -- Bulletins / news (bulletins.mu)
#
# Your "message of the day" board. Add newest entries at the TOP, a few
# lines each. No comment system -- replies come in over LXMF to this
# node's address.
#
# Template for a new bulletin (copy the two lines below the "#"):
#   >YYYY-MM-DD  -  Short title
#   One or two sentences. That is it.
...
-
`[<< Main menu`:/page/index.mu]     `[Links >>`:/page/links.mu]
