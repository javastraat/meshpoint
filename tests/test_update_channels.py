...
class TestReleaseChannelRegistry(unittest.TestCase):
    ...
    def test_find_returns_rc_channel(self) -> None:
        ...
        self.assertEqual(match.branch, "feat/v0.7.8")
    ...
    def test_normalize_channel_id_remaps_retired_rc(self) -> None:
        self.assertEqual(normalize_channel_id("rc-074"), "rc-078")
        self.assertEqual(normalize_channel_id("rc-075"), "rc-078")
        self.assertEqual(normalize_channel_id("rc-076"), "rc-078")
        self.assertEqual(normalize_channel_id("rc-077"), "rc-078")
