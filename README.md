...
| `GET/POST /api/{rtl433,acars,adsb}/...` | Same shape, provided by the RTL433/ACARS/ADS-B plugins when enabled (see [Plugins](#plugins)) — not present unless installed |
