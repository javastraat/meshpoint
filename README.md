...
- **ADS-B tab** via [`dump1090`](https://github.com/MalcolmRobb/dump1090) — live air traffic table (ICAO, flight, altitude, speed, track, position) from 1090 MHz transponder squitters. New `/api/adsb/*` endpoints.
