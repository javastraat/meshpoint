...
| `GET/POST /api/reticulum/...` | Reticulum/LXMF status, peer roster, conversation history, send, announce — provided by the Reticulum plugin when enabled (see [Plugins](#plugins)) |
